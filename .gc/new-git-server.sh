...
gitcid_new_git_server_usage() {
  ...
  echo "-----"
  echo ""
  echo "  $0 [-y[o]] [\$USER@]<target new git server's ssh path> [target2 [target3 ...]]"
  echo ""
  echo "Examples"
  echo "--------"
  echo ""
  echo "Interactive:"
  echo ""
  echo "  $0 git1 [git2 [git3 ...]]"
  echo ""
  echo "Interactive, open web browser:"
  echo ""
  echo "  $0 -o git1 [git2 [git3 ...]]"
  echo ""
  echo "Non-interactive:"
  echo ""
  echo "  $0 -y git1 [git2 [git3 ...]]"
  echo ""
  echo "Non-interactive, open web browser:"
  echo ""
  echo "  $0 -yo git1 [git2 [git3 ...]]"
  echo ""
  echo "Sequential mode (instead of the default parallel mode when"
  echo "installing multiple targets), non-interactive:"
  echo ""
  echo "  $0 -s git1 [git2 [git3 ...]]"
  echo ""
  echo "Sequential mode non-interactive, open web browser:"
  echo ""
  echo "  $0 -so git1 [git2 [git3 ...]]"
  echo ""
  echo "--------"
  echo ""
